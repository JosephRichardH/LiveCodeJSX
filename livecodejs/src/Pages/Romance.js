    ...
    render() {
        if (!this.props.islogin){
            ...
            return(
                ...
                <span class="gallery">Romance</span>
                <hr/>
                <div class="container">
                    {this.props.potonganRomance}
                </div>
            </body>
            )};
  }
}
export default connect("islogin,username,password,listFilm,listRomance,listAction,listFiction,listComedy",actions) (withRouter(Romance))